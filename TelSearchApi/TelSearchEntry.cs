namespace TelSearchApi
{
  ...
  public class TelSearchEntry
  {
    ...
    private void InitVars()
    {
      ...
      VCardUrl = string.Empty;
      ResultPosition = 0;
      TelSearchId = string.Empty;
      AddressType = TelSearchAddressType.Unknown;
    ...
    public TelSearchAddressType AddressType { get; private set; }
